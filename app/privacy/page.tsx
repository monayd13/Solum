...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Privacy" title="Your conversations deserve clear boundaries.">
      ...
      <section><h2>Your controls</h2><p>You can review, export, and permanently delete saved memories from your account. Contact the product owner through the repository support channel to request account deletion or a complete data export.</p></section>
